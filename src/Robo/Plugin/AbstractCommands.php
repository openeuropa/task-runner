...
namespace OpenEuropa\TaskRunner\Robo\Plugin;
 ...
 */
abstract class AbstractCommands extends Tasks implements BuilderAwareInterface, IOAwareInterface, ConfigAwareInterface
{
